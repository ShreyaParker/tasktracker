...
const TaskForm = () => {
    const { initialTask,setInitialTask, setOpenForm  , readOnly} = useFormContext();
    ...
    const handleChange = (e) => {
        ...
        if (initialTask && name === "status" && value === "completed") {
            setTask(prevState => ({
                ...prevState,
                ...
                <form onSubmit={handleSubmit} >
                    ...
                    <div className="flex flex-row">
                        <div className="pt-3 py-3">
                            ...
                            <select className={`${initialTask ? "bg-white" : "bg-zinc-300"} px-2`}
                                    value={task.priority}
                                    onChange={handleChange}
                                    name="priority"
                            >
